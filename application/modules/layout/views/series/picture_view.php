<div class="panel panel-danger">
					...
					<?php
						...
						echo '<a href="/publish/detail/'.$value->id.'" data-toggle="tooltip" data-placement="bottom" title="'.$value->pic_name_cn.'" class="thumbnail" style="border:0px;padding:20px 0 0px 0;">';
